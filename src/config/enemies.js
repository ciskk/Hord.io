...
export const BOSS_TYPES = {
  1: { name: 'Lorde Vampírico', hp: 9800, radius: 56, speed: 1.85, color: '#8e44ad', damage: 36, xp: 120, bossId: 1 },
  2: { name: 'Monólito Abissal', hp: 28500, radius: 76, speed: 0.95, color: '#c0392b', damage: 72, xp: 250, bossId: 2 },
