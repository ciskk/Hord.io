...
export const BOSS_TYPES = {
  ...
  2: { name: 'Monólito Abissal', hp: 40000, radius: 48, speed: 0.95, color: '#c0392b', damage: 50, xp: 80000, bossId: 2 },
  3: { name: 'Ceifador Supremo', hp: 60000, radius: 44, speed: 2.1, color: '#00cec9', damage: 70, xp: 360000, bossId: 3 },
