...
export function updateAbyssalMonolith(e, dt, context) {
  ...
  if (e.actionState !== MONOLITH_STATES.POST_ATTACK_RECOVERY && e.actionState !== MONOLITH_STATES.RECOVERY && !e.aimLocked) {
  ...
  if (hpRatio < MONOLITH_CONFIG.P2_HP_RATIO && !e.hasTransitionedP2) {
  ...
  if (hpRatio < MONOLITH_CONFIG.P3_HP_RATIO && !e.isPhase3) {
    e.isPhase3 = true;
    e.phase = 3;
