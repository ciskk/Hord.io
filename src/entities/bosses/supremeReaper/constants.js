...
export const REAPER_STATES = Object.freeze({
  ...
  WINDUP_BOOMERANG: 'WINDUP_BOOMERANG',
  BOOMERANG_ACTIVE: 'BOOMERANG_ACTIVE',
  WINDUP_EXECUTION: 'WINDUP_EXECUTION',
  WINDUP_SOUL_WELLS: 'WINDUP_SOUL_WELLS',
  WINDUP_TRIAD_SLASH: 'WINDUP_TRIAD_SLASH',
  RECOVERY: 'RECOVERY',
...
export const REAPER_SKILLS = Object.freeze({
  ...
  SCYTHE_BOOMERANG: 'SCYTHE_BOOMERANG',
  DEATH_MARK_EXECUTION: 'DEATH_MARK_EXECUTION',
  SOUL_WELLS: 'SOUL_WELLS',
  PHANTOM_TRIAD_SLASH: 'PHANTOM_TRIAD_SLASH'
});
...
export const REAPER_CONFIG = Object.freeze({
  ...
  // Foice Bumerangue
  BOOMERANG_SPEED: 9.5,
  BOOMERANG_GRIND_TIME: 42,
  BOOMERANG_RADIUS: 34,

  // Guilhotina / Marca da Morte
  EXECUTION_WINDUP: 65,
  EXECUTION_LOCK_LEAD: 18,
  EXECUTION_RADIUS: 46,
