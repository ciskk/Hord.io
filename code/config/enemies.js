...
export const BOSS_TYPES ={
  1: { name: 'Lorde Vampírico', hp: 16500, radius: 56, speed: 1.85, color: '#8e44ad', damage: 36, xp: 120, bossId: 1 },
  2: { name: 'Monólito Abissal', hp: 42000, radius: 76, speed: 0.95, color: '#c0392b', damage: 72, xp: 250, bossId: 2 },
  3: { name: 'Ceifador Supremo', hp: 62000, radius: 68, speed: 2.1, color: '#d35400', damage: 90, xp: 450, bossId: 3 },
  4: { name: 'Soberano do Abismo', hp: 135000, radius: 88, speed: 1.3, color: '#e74c3c', damage: 110, xp: 1200, bossId: 4, isFinalBoss: true }
};
...
export const MINI_BOSS_TYPES ={
  ...
  // Onda 4
  ARTILLERY_MECH: { name: 'Torre Móvel', radius: 25, speed: 0.9, hp: 750, color: '#2980b9', behavior: 'shooter', damage: 20, xp: 55, gold: 22 },
  ...
  // Onda 5
  BROOD_MATRIARCH:{ name: 'Matriarca Parasita', radius: 25, speed: 1.3, hp: 880, color: '#00cec9', behavior: 'splitter_queen', damage: 22, xp: 70, gold: 30 },
  ...
  // Onda 6
  HIGH_OCCULTIST: { name: 'Alto Sacerdote', radius: 24, speed: 1.0, hp: 950, color: '#341f97', behavior: 'gravity_ritual', damage: 24, xp: 80, gold: 35 },
  RUNIC_WARDEN:   { name: 'Guardião Rúnico', radius: 27, speed: 1.1, hp: 1200, color: '#0984e3', behavior: 'protect_aura', damage: 20, xp: 85, gold: 35 },
  // Onda 7
  RUST_COLOSSUS:  { name: 'Colosso Ferruginoso', radius: 32, speed: 0.85, hp: 1600, color: '#d35400', behavior: 'boulder_throw', damage: 35, xp: 95, gold: 40 },
  ...
  // Onda 8
  MOBILE_HIVE:    { name: 'Ninho Móvel', radius: 28, speed: 1.3, hp: 1300, color: '#16a085', behavior: 'bat_spawner', damage: 22, xp: 100, gold: 45 },
  ...
  // Ondas 9 e 10
  VOID_PRECURSOR: { name: 'Precursor do Vazio', radius: 27, speed: 1.2, hp: 1800, color: '#8e44ad', behavior: 'vortex_carrier', damage: 32, xp: 120, gold: 50 },
